...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function registerPackageCapsule($name, $namespace, $path, $singular = null, $enabled = true)
        {
                        /** @var \A17\Twill\TwillCapsules $instance */
                        return $instance->registerPackageCapsule($name, $namespace, $path, $singular, $enabled);
        }
                    /**
         * 
         *
